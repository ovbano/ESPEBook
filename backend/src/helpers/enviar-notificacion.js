...
const TOKEN_NOTIFICAIONES = "AAAAfVCwzbI:APA91bHNroyK7rstC92X4n-WYSyuFNTwXtiUiDlzuzulXlWpk35qHvnyokKKGyWBLBVulGpuW59OAUH3dDOTsKirFDcWjexy1KhE1gj3qX_YwaUmtHXhxyapfJ-OP2FL9zqjjMjSl6xl";
    ...
    const response = await axios.post(
      ...
      },
      {
        headers: {
          ...
          Authorization: "key=" + TOKEN_NOTIFICAIONES,
        },
      }
    );
...
const guardarNotificacionPublicacionMensaje = async (
  ...
  try {
    ...
    console.log(error);
    throw new Error(" de publicación");
  }
};
