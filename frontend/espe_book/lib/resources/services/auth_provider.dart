// ignore_for_file: unnecessary_getters_setters, avoid_print, unused_local_variable, unrelated_type_equality_checks

import 'dart:convert';

import 'package:connectivity_plus/connectivity_plus.dart';
import 'package:espe_book/models/ubicacion.dart';
import 'package:espe_book/resources/services/push_notifications_service.dart';
import 'package:flutter_secure_storage/flutter_secure_storage.dart';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';
import 'package:google_sign_in/google_sign_in.dart';
import 'package:espe_book/global/environment.dart';
import 'package:espe_book/models/login_response.dart';
...
// router.put("/actualizar-is-open-room", validarJWT, actualizarIsOpenRoom);
  Future<bool> actualizarIsOpenRoom(bool isOpenRoom) async {
    try {
      ...
      final uri =
          Uri.parse('${Environment.apiUrl}/usuario/actualizar-is-open-room');
  ...
  Future<bool> addTelefono(String telefono) async {
    ...
    final uri = Uri.parse('${Environment.apiUrl}/usuario/add-telefono');
  ...
  Future<bool> addTelefonos(String telefonos) async {
    ...
    final uri = Uri.parse('${Environment.apiUrl}/usuario/add-telefonos');
  ...
  Future<bool> deleteTelefono(String telefono) async {
    ...
    final uri = Uri.parse('${Environment.apiUrl}/usuario/delete-telefono');
  ...
  Future<bool> notificacion(double lat, double lng) async {
    ...
    final uri = Uri.parse('${Environment.apiUrl}/usuario/notificacion');
  ...
  Future<bool?> updateUsuario(String nombre, String telefono) async {
    ...
    final uri = Uri.parse('${Environment.apiUrl}/usuario/add-telefono-nombre');
  ...
  Future<bool> marcarPublicacionPendienteFalse() async {
    try {
      final uri = Uri.parse(
          '${Environment.apiUrl}/usuario/marcar-publicacion-pendiente-false');
  ...
  Future<bool> marcarSalaPendienteFalse() async {
    try {
      final uri = Uri.parse(
          '${Environment.apiUrl}/usuario/marcar-sala-pendiente-false');
      final resp = await http.put(uri, headers: {
        'Content-Type': 'application/json',
        'x-token': await getToken() as String,
      });
  ...
  Future<bool> marcarNotificacionesPendienteFalse() async {
    try {
      final uri = Uri.parse(
          '${Environment.apiUrl}/usuario/marcar-notificaciones-pendiente-false');
      final resp = await http.put(uri, headers: {
        'Content-Type': 'application/json',
        'x-token': await getToken() as String,
      });
  ...
  Future<bool> eliminarTokenApp() async {
    try {
      final uri = Uri.parse('${Environment.apiUrl}/usuario/delete-token-app');
      final resp = await http.delete(uri, headers: {
        'Content-Type': 'application/json',
        'x-token': await getToken() as String,
      });
